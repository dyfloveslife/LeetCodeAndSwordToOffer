 ...
 * 4. 如果 p1 > p2，则将 p1 加入到最终的结果数组中，此时统计 p2 指向的数与其前面一共有多少数，有多少数就有几对逆序对。因为 p1 指向的数都要比 p2 指向的子数组
 *    中的数要大，并且 p1 指针左移，p3 也要左移；
 *    如果 p1 < p2，则说明没有逆序对，此时将 p2 所指的数加入到 p3 的位置即可。
 * 5. 总之，谁大就移动谁，然后将较大的数复制到 p3 所指向的最终结果数组中即可。
 */
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int[] arr = {7, 5, 6, 4};
        int ans = solution.inversePairs(arr);
