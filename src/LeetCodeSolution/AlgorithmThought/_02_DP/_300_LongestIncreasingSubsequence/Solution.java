 ...
 *
 * 思路二：二分
 * 0. https://leetcode-cn.com/problems/longest-increasing-subsequence/solution/dong-tai-gui-hua-she-ji-fang-fa-zhi-pai-you-xi-jia/
 * 1. 类似于电脑上的“蜘蛛纸牌”游戏，在玩游戏的过程中会分成不同的“部分”，每个部分的纸牌摆放规则是：
 *    只有小牌才能放在大牌上面，如果有更大牌的话，则需要新开一个“部分”；
 *    如果在放牌的过程中，可以选择多个堆进行放牌，那么需要放在最左侧的那个堆，因为这样可以保证堆顶都是有序的。
